...
IPv4は約43億個のアドレスしかなく、インターネットの普及に伴って不足しました。すべての家庭内端末や社内端末へグローバルIPv4アドレスを一つずつ割り当てることは困難です。
...
flowchart LR
    ...
    NAT["NATルータ<br/>203.0.113.5"]
    WEB["Webサーバ<br/>198.51.100.20:443"]
    PC1 --> NAT
    PC2 --> NAT
    NAT -- "203.0.113.5:40001<br/>203.0.113.5:40002" --> WEB
```

ポート番号も使うことで、同じグローバルIPv4アドレスを複数の内部通信で共有できます。
